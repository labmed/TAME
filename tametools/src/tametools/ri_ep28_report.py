...
CAUTIONS = [
    ...
    "이동 Box–Cox의 원점·power 추정은 선언한 탐색 범위에 의존합니다. 경계 도달과 변환 후 정규성을 확인하십시오. 과거 연구의 세부 적합 설정이 공개되지 않았다면 동일한 방법 계열이라도 원 논문 수치의 완전 재현을 뜻하지 않습니다.",
    "BOOTSTRAP_MEAN은 재표집 참고한계의 평균을 점추정으로 보고합니다. 50회는 원 연구 재현을 위한 선택지로 제공하며 정밀도 보장은 아닙니다. R과 Python은 같은 seed만으로 동일 재표집이 되지 않습니다. R_BOOT와 TYPE7의 CI 끝점 보간도 구분합니다.",
...
SOURCES = [
    ...
    ("CLSI EP28-A3c: 9.1–9.5, 11.2, Appendix B (사용자 제공 원문 대조)","https://clsi.org/shop/standards/ep28/"),
